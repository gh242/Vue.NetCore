<template>
	<view>
		...
		<view class="home-content">
			<view class="app-name">vol框架移動端</view>
			<view class="card-container">
				<view class="fn-title">基礎功能</view>
			...
			<view style="padding:30rpx;padding-top:0;">
				<vol-alert type="primary">
					<view>1、VOL移動端基於uniapp、uview開發。</view>
					<view>2、移動端與PC端同樣自動控制權限。</view>
					<view>3、移動端代碼完全由代碼生成器生成。</view>
					<view>4、移動端與PC端同一套後台接口,開發方式不變。</view>
					<view>5、移動端同樣viewgrid、volform、voltable組件</view>
