    ...
    public class HttpResultfulJob : IJob
    {
        ...
        public async Task Execute(IJobExecutionContext context)
        {
            ...
            finally
            {
                ...
                {
                    Console.WriteLine($"日誌寫入異常:{taskOptions.TaskName},{ex.Message}");
                    QuartzFileHelper.Error($"日誌寫入異常:{typeof(HttpResultfulJob).Name},{taskOptions.TaskName},{ex.Message}");
                }
            }
