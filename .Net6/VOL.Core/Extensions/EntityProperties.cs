...
namespace VOL.Core.Extensions
{
    public static class EntityProperties
    {
        ...
        /// <param name="lenght">是否包括後字段具體長度:nvarchar(100)</param>
        /// <returns></returns>
        ...
        /// <summary>
        ///此方法适用於數據量少,只有幾列數據，不超過1W行，或幾十列數據不超過1000行的情况下使用
        /// 大批量的數據考虑其他方式
        ...
        public static string GetKeyName(this PropertyInfo[] properties, bool keyType)
        {
            ...
            foreach (PropertyInfo propertyInfo in properties)
            {
                ...
                //如果沒有ColumnAttribute的需要單独再驗證，下面只驗證有屬性的
        ...
        public static WebResponseContent ValidationEntity<T>(this T entity, string[] specificProperties, string[] validateProperties = null)
        {
            ...
            foreach (PropertyInfo propertyInfo in propertyArray)
            {
                ...
                //若存在specificProperties並且屬性為數組specificProperties中的值，校驗時就需要判斷是否為空
        ...
        /// 驗證數據庫字段類型與值是否正確，
        /// </summary>
        /// <param name="dbType">數據庫字段類型(如varchar,nvarchar,decimal,不要帶後面長度如:varchar(50))</param>
        ...
        {
            if (dic == null || dic.Count == 0) { return "參數無效"; }
            if (propertyInfo == null)
        ...
        /// <summary>
        /// 將實體映射到輸出到ApiOutput實體上,如果沒有輸入實體，則返回null
        /// </summary>
        /// <param name="entity"></param>
        /// <returns></returns>
        ...
        /// false=編輯設置"ModifyID", "Modifier", "ModifyDate"值
        /// </param>
