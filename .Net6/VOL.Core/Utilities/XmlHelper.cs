...
namespace Rattan.Basic.Utility
{
	...
	public class XMLHelper
	{
		...
		/// <param name="node">節點對象</param>
		/// <param name="nodeName">節點名稱</param>
		/// <param name="innerText">節點内容</param>
		...
		/// <param name="index">節點索引</param>
		/// <param name="nodeName">節點名稱</param>
		/// <param name="newInnerText">修改後的内容</param>
		...
		/// <param name="innerText">修改後的内容</param>
		...
		/// <param name="xDoc">XmlDocument對象</param>
		/// <param name="nodeName">節點名稱</param>
		/// <param name="nodeText">節點内容</param>
