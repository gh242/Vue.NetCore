<template>
  <div class="upload-container">
    ...
    <div class="button-group">
      ...
      >
        <el-button size="small"
          ><i class="el-icon-folder-opened"></i>選擇文件</el-button
        >
      </el-upload>
      <el-button
        v-if="template.url"
    ...
    <div class="alert">
      <el-alert title="上傳說明" type="warning" :closable="false" show-icon
        >只能上傳excel文件,文件大小不超過{{ maxSize }}M</el-alert
      >
    </div>
...
export default {
  ...
  props: {
    ...
    template: {
      ...
      default: () => {
        return {
          url: '', //模板下載路徑，如果沒有模板路徑，則不顯示下載模板功能
