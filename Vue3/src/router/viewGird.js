...
let viewgird = [
  ...
  , {
    ...
    component:  () => import('@/views/appmanager/App_NewsEditor.vue' )
        ...
        path: '/Demo_Catalog',
        name: 'Demo_Catalog',
        component: () => import('@/views/demo/catalog/Demo_Catalog.vue')
    }    ,{
        path: '/Demo_Order',
        name: 'Demo_Order',
        component: () => import('@/views/demo/order/Demo_Order.vue')
    }    ,{
        path: '/Demo_OrderList',
        name: 'Demo_OrderList',
        component: () => import('@/views/demo/order/Demo_OrderList.vue')
    }    ,{
        path: '/View_OrderInfo',
        name: 'View_OrderInfo',
        component: () => import('@/views/demo/order/View_OrderInfo.vue')
    }    ,{
        path: '/Demo_Customer',
        name: 'Demo_Customer',
        component: () => import('@/views/demo/customer/Demo_Customer.vue')
    }    ,{
        path: '/Demo_Goods',
        name: 'Demo_Goods',
        component: () => import('@/views/demo/goods/Demo_Goods.vue')
    }]
