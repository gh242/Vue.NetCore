 ...
 *業務請在@/extension/system/Sys_Dictionary.js此處編寫
 -->
<template>
    <view-grid ref="grid"
               :columns="columns"
    ...
    export default defineComponent({
        setup() {
            ...
            const editFormOptions = ref([[{"title":"字典編號","required":true,"field":"DicNo"},
                               ...
                               {"title":"父級ID","required":true,"field":"ParentId","type":"number"}],
            ...
            const searchFormOptions = ref([[{"title":"字典編號","field":"DicNo"},{"title":"字典名稱","field":"DicName","type":"textarea"},{"title":"父級ID","field":"ParentId","type":"number"}],[{"dataKey":"enable","data":[],"title":"是否啟用","field":"Enable","type":"select"},{"title":"創建時間","field":"CreateDate","type":"datetime"},{"title":"修改時間","field":"ModifyDate","type":"datetime"}]]);
            const columns = ref([{field:'Dic_ID',title:'字典ID',type:'int',width:90,hidden:true,readonly:true,require:true,align:'left'},
                       {field:'DicNo',title:'字典編號',type:'string',width:90,require:true,align:'left',sort:true},
                       {field:'DicName',title:'字典名稱',type:'string',link:true,width:140,require:true,align:'left'},
                       {field:'ParentId',title:'父級ID',type:'int',width:90,require:true,align:'left'},
                       ...
                       {field:'ModifyDate',title:'修改時間',type:'datetime',width:150,readonly:true,align:'left',sort:true}]);
            const detail = ref({
                cnName: "字典明細",
                ...
                columns: [{field:'DicList_ID',title:'DicList_ID',type:'int',width:90,hidden:true,readonly:true,require:true,align:'left'},
                       ...
                       {field:'CreateDate',title:'創建時間',type:'datetime',width:90,readonly:true,align:'left',sort:true},
                       {field:'ModifyID',title:'ModifyID',type:'int',width:90,hidden:true,align:'left'},
                       {field:'Modifier',title:'修改人',type:'string',width:130,align:'left'},
                       {field:'ModifyDate',title:'修改時間',type:'datetime',width:90,align:'left',sort:true}],
                sortName: "DicList_ID",
                key: "DicList_ID"
            });
            return {
