...
export default {
  ...
  data() {
    return {
      ...
      list: [
        { desc: '框架2.x版本不支持直接升級Vue3版本(代碼生成器已修改)' },
        { desc: '框架使用的Element Plus組件，移除了Iview組件的依賴' },
        { desc: '框架内部組件全部重新優化,相比2.x版本首屏大小减少60%' },
        { desc: '框架Vue2版本會繼續維護,並與4Vue3版本同步更新,請放心使用' },
        { desc: '框架Vue2、Vue3版本開發文檔一致(差異部分文檔會備註說明)' },
        //{ desc: "若正在使用Vue2框架版本繼續使用即可;其他建議使用Vue3版本" },
        {
          desc: 'vue2、vue3文檔相同,開文檔大部分文檔仍然使用的vue2語法'
        },
        {
          desc: '自定義部分既可以使用vue3語法與4可以使用vue3語法'
        }
        //(框架内部組件vue2/3語法都在使用),你也可以使用vue3語法
      ],
      grid: [
        {
          name: '用戶管理',
          desc: '系統用戶管理,注冊用戶3000000人。',
          icon: 'el-icon-user'
        },
        {
          name: '站内消息',
